...
- [Low Level Design](https://github.com/InterviewReady/Low-Level-Design)
- [Low Level Design Primer](https://github.com/prasadgujar/low-level-design-primer)
- [Scalable System Design](https://github.com/karanpratapsingh/system-design)
...
7. [Diagrams](https://github.com/mingrammer/diagrams)
...
12. [Data Engineering Wiki](https://dataengineering.wiki/Index)
...
23. [Python Patterns](https://github.com/faif/python-patterns)
24. [Python 3 Patterns, Recipes and Idioms](https://python-3-patterns-idioms-test.readthedocs.io/en/latest/index.html)
...
28. [python-anti-patterns](https://github.com/quantifiedcode/python-anti-patterns)
29. [Distributed Computing](https://distributed-computing-musings.com/)
30. [solution-architecture-patterns](https://github.com/chanakaudaya/solution-architecture-patterns)
...
42. [Calm Code](https://calmcode.io/)
...
3. [Software_architecture](https://en.wikipedia.org/wiki/Category:Software_architecture)
    ...
    * [Service-oriented Architecture](https://en.wikipedia.org/wiki/Category:Service-oriented_(business_computing))
    * [Architectural Pattern](https://en.wikipedia.org/wiki/Category:Architectural_pattern_(computer_science))
...
4. [Software_engineering](https://en.wikipedia.org/wiki/Category:Software_engineering)
    * [Software Design Patterns](https://en.wikipedia.org/wiki/Category:Software_design_patterns)
    * [Software Design](https://en.wikipedia.org/wiki/Category:Software_design)
    * [Software Development](https://en.wikipedia.org/wiki/Software_development)
    * [Agile Development](https://en.wikipedia.org/wiki/Category:Agile_software_development)
    * [Software_development_philosophies](https://en.wikipedia.org/wiki/Category:Software_development_philosophies)
    * [Software_testing](https://en.wikipedia.org/wiki/Category:Software_testing)
5. [Software_requirements](https://en.wikipedia.org/wiki/Category:Software_requirements)
...
6. [Systems_theory](https://en.wikipedia.org/wiki/Category:Systems_theory)
    * [Systems_engineering](https://en.wikipedia.org/wiki/Category:Systems_engineering)
    * [Systems_science](https://en.wikipedia.org/wiki/Category:Systems_science)
    * [Systems_analysis](https://en.wikipedia.org/wiki/Systems_analysis)
7. [Cloud Computing](https://en.wikipedia.org/wiki/Category:Cloud_computing)
...
8. [Unified Modeling Language](https://en.wikipedia.org/wiki/Category:Unified_Modeling_Language)
