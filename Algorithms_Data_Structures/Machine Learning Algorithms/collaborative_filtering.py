...
class CollaborativeFiltering:
    def fit(self, X, y, dimension, learning_rate, epochs):
        ...
        for _ in range(epochs):
            ...
            r = (
                self.__user_vector[user_index].dot(self.__item_vector[item_index].T)
                + self.__user_bias[user_index]
                + self.__item_bias[item_index]
                - y[index]
            )
            ...
            user_vector_new = (
                self.__user_vector[user_index]
                - learning_rate * r * self.__item_vector[item_index]
            )
            self.__user_bias[user_index] -= learning_rate * r
            item_vector_new = (
                self.__item_vector[item_index]
                - learning_rate * r * self.__user_vector[user_index]
            )
