...
class Tree:
    ...
    def inorder(root):
        if root == None:
            ...
            return (
                str(Tree.inorder(root.left))
                + " "
                + str(root.key)
                + " "
                + str(Tree.inorder(root.right))
            )
    ...
    def preorder(root):
        if root == None:
            ...
            return (
                str(root.key)
                + " "
                + str(Tree.preorder(root.left))
                + " "
                + str(Tree.preorder(root.right))
            )
    ...
    def postorder(root):
        if root == None:
            ...
            return (
                str(Tree.postorder(root.left))
                + " "
                + str(Tree.postorder(root.right))
                + " "
                + str(root.key)
            )
