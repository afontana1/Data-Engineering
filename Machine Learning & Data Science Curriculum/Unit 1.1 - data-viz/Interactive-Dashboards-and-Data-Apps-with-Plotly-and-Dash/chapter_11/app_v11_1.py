...
countries = (
    poverty[poverty["is_country"]]["Country Name"]
    .drop_duplicates()
    .sort_values()
    .tolist()
)
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Row([dbc.Col(dcc.Graph(id="country_page_graph"))]),
                        dbc.Row(
                            [
                                dbc.Col(
                                    [
                                                    ...
                                                    [
                                                        ...
                                                        dcc.Dropdown(
                                                            ...
                                                            options=[
                                                                ...
                                                                for indicator in poverty.columns[
                                                                    3:54
                                                                ]
                                                            ],
                                                        ),
...
@app.callback(Output("main_content", "children"), Input("location", "pathname"))
...
def clustered_map(n_clicks, year, n_clusters, indicators):
    ...
    if df.isna().all().any():
        return px.scatter(
            title="No available data for the selected combination of year/indicators."
        )
...
@app.callback(
    Output("country_page_contry_dropdown", "value"), Input("location", "pathname")
)
