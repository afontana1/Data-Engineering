...
class Grader(object):
    ...
    def submit(self, email, token):
        ...
        elif "details" in response and "learnerMessage" in response["details"]:
            print(response["details"]["learnerMessage"])
        else:
    ...
    def submit_pymc_map_estimates(
        self, beta_age_coefficient, beta_education_coefficient
    ):
    ...
    def submit_pymc_odds_ratio_interval(
        self, odds_ratio_lower_bound, odds_ratio_upper_bound
    ):
